...
// 初始化
export function initFreeline(viewer: Ref<Cesium.Viewer | undefined>) {
  anchorpoints = [];
  polyline = null;
...
// 创建线段
export function createFreeline(
...
export function endFreeline(viewer: Ref<Cesium.Viewer | undefined>) {
  // anchorpoints.pop();
