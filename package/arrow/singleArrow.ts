...
export class SingleArrow extends Basic {
    points: Cartesian3[] = [];
    ...
    createGraphic(positions: Cartesian3[]): Cartesian3[] {
        ...
        const headPnts: LngLat[] = this.getArrowHeadPoints(bonePnts, tailLeft, tailRight) as LngLat[];
        ...
        const points: any[] = leftPnts.concat(headPnts, rightPnts.reverse());
    ...
    getArrowHeadPoints(points: LngLat[], tailLeft: LngLat, tailRight: LngLat) {
        try {
    ...
    getArrowBodyPoints(points: LngLat[], neckLeft: LngLat, neckRight: LngLat, tailWidthFactor: number) {
