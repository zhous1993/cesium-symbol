...
export class PincerArrow extends Basic {
  points: Cartesian3[] = [];
  ...
  llBodyPnts: LngLat[] = [];
  rrBodyPnts: LngLat[] = [];
  curveControlPointLeft: Cartesian3 = null as unknown as Cartesian3;
  curveControlPointRight: Cartesian3 = null as unknown as Cartesian3;
  ...
  createGraphic(positions: Cartesian3[]) {
    ...
    const pnts: any = rlBodyPnts.concat(rArrowPnts, bodyPnts, lArrowPnts, lrBodyPnts);
  ...
  getArrowPoints(pnt1: LngLat, pnt2: LngLat, pnt3: LngLat, clockWise: boolean): LngLat[] {
    ...
    if (arrowPnts && Array.isArray(arrowPnts) && arrowPnts.length > 0) {
      const neckLeftPoint: LngLat = arrowPnts[0];
      const neckRightPoint: LngLat = arrowPnts[4];
  ...
  getArrowBodyPoints(points: LngLat[], neckLeft: LngLat, neckRight: LngLat, tailWidthFactor: number): LngLat[] {
    ...
    let leftBodyPnts: LngLat[] = [];
    let rightBodyPnts: LngLat[] = [];
