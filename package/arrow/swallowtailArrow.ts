...
import { LngLat, PolygonStyle } from '../type';
import { SingleArrow } from './singleArrow';

export class SwallowtailArrow extends SingleArrow {
  points: Cartesian3[] = [];
  ...
  createGraphic(positions: Cartesian3[]): Cartesian3[] {
    ...
    const headPnts: LngLat[] = this.getArrowHeadPoints(bonePnts, tailLeft, tailRight)!;
    ...
    const points: any = leftPnts.concat(headPnts, rightPnts.reverse(), [this.swallowTailPnt, leftPnts[0]]);
